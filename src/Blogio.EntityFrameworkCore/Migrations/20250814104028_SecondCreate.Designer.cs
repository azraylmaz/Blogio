...
namespace Blogio.Migrations
{
    ...
    [Migration("20250814104028_SecondCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBlog.Blog.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyBlog.Blog.BlogPostTag", b =>
                {
            ...
            modelBuilder.Entity("MyBlog.Blog.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyBlog.Blog.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyBlog.Blog.BlogPostTag", b =>
                {
                    b.HasOne("MyBlog.Blog.BlogPost", "BlogPost")
                        .WithMany("BlogPostTags")
                        .HasForeignKey("BlogPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyBlog.Blog.Tag", "Tag")
                        .WithMany("BlogPostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
